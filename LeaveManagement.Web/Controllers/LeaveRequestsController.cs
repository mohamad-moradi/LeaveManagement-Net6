...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                LeaveTyps = new SelectList(_context.LeaveTypes, "Id", "Name")
            };
        ...
        public async Task<IActionResult> Create(LeaveRequestCreateVM model)
        {
            ...
            model.LeaveTyps = new SelectList(_context.LeaveTypes, "Id", "Name", model.LeaveTypeId);
            return View(model);
        }

        public async Task<IActionResult> MyLeave()
        {
            var model = await leaveRequestRepository.GetMyLeaveDetailesAsync();
            return View(model);
        }
